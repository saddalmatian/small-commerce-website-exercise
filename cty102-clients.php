...
<head>
    ...
    <link href="css/cty102clients.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <h2 style="text-align:center">Bảng danh sách khách hàng</h2>
    <hr>
    <div class="contable">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo '<tr>
                        <th scope="row"><a href="cty102-cinfo.php?id=' . $row['MSKH'] . '">' . $row['MSKH'] . '</a></th>
                        <td><h5>' . $row['HoTenKH'] . '</h5></td>
                        <td><h5>' . $row['TenCongTy'] . '</h5></td>
                        <td><h5>' . $row['SoDienThoai'] . '</h5></td>
                        <td><h5>' . $row['SoFax'] . '</h5></td>
